  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <p className="mt-4 max-w-xl text-sm leading-relaxed text-muted">
        {preview
          ? "Preview tape — sample holder, not your wallet. Connect on Arc to read real balances once the keeper is live."
          : connected
            ? "Desk is open. Distributions stay empty until tokenized names list and the keeper buys."
            : "Connect a desk or flip on the preview tape to read balances and the distribution ledger."}
      </p>
      {!seeing ? (
      ...
      <div className="mt-10 grid gap-px overflow-hidden rounded-xl bg-border sm:grid-cols-3">
        ...
        <Metric
          ...
          hint="Current value of names in the desk."
        />
      </div>
