...
import { STOCKS, SLEEVES, sleeveWeight } from "@/lib/stocks";
  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <p className="mt-4 max-w-xl text-sm leading-relaxed text-muted">
        Creator-chosen. The keeper only buys names on this list, and only after they list on Arc. Weights split the 70% creator slice of the 1% Uniswap v4 fee (the Creator row on eve.fun, paid to the rewards wallet). Not a promise of fill.
      </p>
      ...
      <div className="mt-8 grid gap-3 sm:grid-cols-3">
        {SLEEVES.map((s) => (
          <div key={s.id} className="panel-tight p-5">
          ...
          {STOCKS.map((s) => (
            ...
            >
              ...
              <div className="col-span-full h-1 overflow-hidden rounded-full bg-elevated md:col-span-6">
                <div className="h-full rounded-full bg-accent" style={{ width: `${s.weight * (100 / 16)}%` }} />
              </div>
            </li>
          ))}
        </ul>
